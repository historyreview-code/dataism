...
export const CHAPTERS = [
  {
    ...
    palette: { inner: '#8FB4FF', outer: '#A8662F', core: '#E8E8F4' },
    behavior: { flow: 0.034, noiseAmp: 0.14, sizeScale: 1.0, mouseStrength: 1.1, orbitAmp: 0.14, orbitTempo: 0.14 },
    soundscape: 'tide',
    energy: 0.2,
  },
  {
    ...
    palette: { inner: '#8FA8E8', outer: '#96582C', core: '#E4D8CC' },
    behavior: { flow: 0.030, noiseAmp: 0.12, sizeScale: 0.95, mouseStrength: 0.9, orbitAmp: 0.11, orbitTempo: 0.10 },
    soundscape: 'drone',
    energy: 0.15,
  },
  {
    ...
    palette: { inner: '#A9C6DE', outer: '#C08850', core: '#F4F0E4' },
    behavior: { flow: 0.040, noiseAmp: 0.16, sizeScale: 1.0, mouseStrength: 1.2, orbitAmp: 0.18, orbitTempo: 0.17 },
    soundscape: 'drift',
    energy: 0.3,
  },
  {
    ...
    behavior: { flow: 0.042, noiseAmp: 0.19, sizeScale: 1.05, mouseStrength: 1.6, orbitAmp: 0.24, orbitTempo: 0.24 },
    soundscape: 'bloom',
    energy: 0.5,
  },
  {
    ...
    behavior: { flow: 0.055, noiseAmp: 0.21, sizeScale: 1.05, mouseStrength: 1.8, orbitAmp: 0.27, orbitTempo: 0.27 },
    soundscape: 'pulse',
    energy: 0.7,
  },
  {
    ...
    behavior: { flow: 0.065, noiseAmp: 0.26, sizeScale: 1.0, mouseStrength: 2.0, orbitAmp: 0.31, orbitTempo: 0.31 },
    soundscape: 'storm',
    energy: 0.75,
  },
  {
    ...
    behavior: { flow: 0.070, noiseAmp: 0.29, sizeScale: 1.15, mouseStrength: 2.2, orbitAmp: 0.34, orbitTempo: 0.34 },
    soundscape: 'pulse',
    energy: 1.0,
  },
  {
    ...
    behavior: { flow: 0.050, noiseAmp: 0.21, sizeScale: 1.05, mouseStrength: 1.7, orbitAmp: 0.27, orbitTempo: 0.25 },
    soundscape: 'tide',
    energy: 0.6,
  },
  {
    ...
    behavior: { flow: 0.060, noiseAmp: 0.23, sizeScale: 1.0, mouseStrength: 1.9, orbitAmp: 0.29, orbitTempo: 0.28 },
    soundscape: 'storm',
    energy: 0.65,
  },
  {
    ...
    behavior: { flow: 0.045, noiseAmp: 0.18, sizeScale: 1.05, mouseStrength: 1.6, orbitAmp: 0.26, orbitTempo: 0.23 },
    soundscape: 'tide',
    energy: 0.5,
  },
  {
    ...
    behavior: { flow: 0.038, noiseAmp: 0.16, sizeScale: 1.0, mouseStrength: 1.5, orbitAmp: 0.22, orbitTempo: 0.19 },
    soundscape: 'bloom',
    energy: 0.45,
  },
  {
    ...
    palette: { inner: '#8093E0', outer: '#A05C30', core: '#E8E0D0' },
    behavior: { flow: 0.036, noiseAmp: 0.14, sizeScale: 1.0, mouseStrength: 1.1, orbitAmp: 0.14, orbitTempo: 0.13 },
    soundscape: 'drift',
    energy: 0.25,
  },
]
