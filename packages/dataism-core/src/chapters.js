...
export const CHAPTERS = [
  {
    ...
    palette: { inner: '#6B8CFF', outer: '#232B66', core: '#B8C4FF' },
    behavior: { flow: 0.022, noiseAmp: 0.10, sizeScale: 0.90, mouseStrength: 1.1 },
    soundscape: 'tide',
    energy: 0.2,
  },
  {
    ...
    palette: { inner: '#8A6FD8', outer: '#2E2360', core: '#C8B8FF' },
    behavior: { flow: 0.016, noiseAmp: 0.07, sizeScale: 0.85, mouseStrength: 0.9 },
    soundscape: 'drone',
    energy: 0.15,
  },
  {
    ...
    palette: { inner: '#9FB4C9', outer: '#46586E', core: '#E8EEF4' },
    behavior: { flow: 0.028, noiseAmp: 0.10, sizeScale: 0.95, mouseStrength: 1.2 },
    soundscape: 'drift',
    energy: 0.3,
  },
  {
    ...
    behavior: { flow: 0.042, noiseAmp: 0.16, sizeScale: 1.05, mouseStrength: 1.6 },
    soundscape: 'bloom',
    energy: 0.5,
  },
  {
    ...
    behavior: { flow: 0.055, noiseAmp: 0.18, sizeScale: 1.05, mouseStrength: 1.8 },
    soundscape: 'pulse',
    energy: 0.7,
  },
  {
    ...
    behavior: { flow: 0.065, noiseAmp: 0.22, sizeScale: 1.0, mouseStrength: 2.0 },
    soundscape: 'storm',
    energy: 0.75,
  },
  {
    ...
    behavior: { flow: 0.070, noiseAmp: 0.24, sizeScale: 1.15, mouseStrength: 2.2 },
    soundscape: 'pulse',
    energy: 1.0,
  },
  {
    ...
    behavior: { flow: 0.050, noiseAmp: 0.18, sizeScale: 1.05, mouseStrength: 1.7 },
    soundscape: 'tide',
    energy: 0.6,
  },
  {
    ...
    behavior: { flow: 0.060, noiseAmp: 0.20, sizeScale: 1.0, mouseStrength: 1.9 },
    soundscape: 'storm',
    energy: 0.65,
  },
  {
    ...
    palette: { inner: '#FFA17A', outer: '#A03E63', core: '#FFDCC6' },
    behavior: { flow: 0.045, noiseAmp: 0.16, sizeScale: 1.05, mouseStrength: 1.6 },
    soundscape: 'tide',
    energy: 0.5,
  },
  {
    ...
    behavior: { flow: 0.038, noiseAmp: 0.14, sizeScale: 1.0, mouseStrength: 1.5 },
    soundscape: 'bloom',
    energy: 0.45,
  },
  {
    ...
    palette: { inner: '#5F74C4', outer: '#232C55', core: '#A8B8E8' },
    behavior: { flow: 0.024, noiseAmp: 0.10, sizeScale: 0.90, mouseStrength: 1.1 },
    soundscape: 'drift',
    energy: 0.25,
  },
]
