...
export const CHAPTERS = [
  {
    ...
    palette: { inner: '#7F9DFF', outer: '#3A4A99', core: '#CBD6FF' },
    behavior: { flow: 0.022, noiseAmp: 0.10, sizeScale: 1.0, mouseStrength: 1.1 },
    soundscape: 'tide',
    energy: 0.2,
  },
  {
    ...
    palette: { inner: '#9F86E8', outer: '#4E3E8F', core: '#DAD0FF' },
    behavior: { flow: 0.016, noiseAmp: 0.07, sizeScale: 0.95, mouseStrength: 0.9 },
    soundscape: 'drone',
    energy: 0.15,
  },
  {
    ...
    palette: { inner: '#A9C6DE', outer: '#5C7796', core: '#EEF3F8' },
    behavior: { flow: 0.028, noiseAmp: 0.10, sizeScale: 1.0, mouseStrength: 1.2 },
    soundscape: 'drift',
    energy: 0.3,
  },
  {
  ...
  },
  {
    ...
    palette: { inner: '#8093E0', outer: '#41508C', core: '#C6D1F4' },
    behavior: { flow: 0.024, noiseAmp: 0.10, sizeScale: 1.0, mouseStrength: 1.1 },
    soundscape: 'drift',
    energy: 0.25,
  },
]
